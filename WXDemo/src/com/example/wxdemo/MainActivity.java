...
/****
 * Fragment + ViewPager + LinearLayout
 ****/
...
public class MainActivity extends FragmentActivity {
	...
	private void initView() {
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener() {
			...
			public void onPageScrolled(int position, float positionOffset, int positionOffsetPx) {
				// TODO Auto-generated method stub
				Log.e("1111", position+ "   " + positionOffset + "   " +positionOffsetPx);
				...
				if (mCurrentPageIndex == 0 && position == 0) {
					layoutParams.leftMargin = (int)positionOffset * mScreen 
							+ mCurrentPageIndex * mScreen;
				} else if (mCurrentPageIndex == 1 && position == 0) {
					layoutParams.leftMargin = (int)(mCurrentPageIndex*mScreen 
							+ (positionOffset - 1) * mScreen);
				} else if (mCurrentPageIndex == 1 && position == 1) {
					layoutParams.leftMargin = (int) (mCurrentPageIndex * mScreen + positionOffset * mScreen);
	...
	private void initTabLine() {
		...
		android.view.ViewGroup.LayoutParams lParams = mTabline.getLayoutParams();
		lParams.width = mScreen;
		mTabline.setLayoutParams(lParams);
	}
